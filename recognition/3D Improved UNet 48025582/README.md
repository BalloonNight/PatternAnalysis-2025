...
stucture of model and diagram from [2]
loosly inspired structure and code functions from [3]
dice loss modified from [4]

## Dependencies
**INCOMPLETE**, all the dependencies required and their version
